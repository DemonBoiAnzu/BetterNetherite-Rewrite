...
public class Config {
    ...
    public static class ConfigOption {
        ...
        public int getIntOption(String optionId) throws Exception {
            if(!options.containsKey(optionId)) throw new Exception("The option id '%s' does not exist in the config option '%s'.".formatted(optionId,id));
    ...
    void loadConfig() throws Exception {
        ...
        String fileContents = Files.readString(configFile.toPath(), Charset.defaultCharset());
